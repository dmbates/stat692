...
```{r dens1,echo=FALSE,fig.align='center',fig.cap="Histogram of the kindergarten mathematics score",fig.height=2.5,fig.width=6.5,out.width="0.8\\textwidth",fig.pos="h",warning=FALSE}
p + geom_density()
```
